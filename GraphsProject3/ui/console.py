from Graph.graph_class import BFSsearch, DijkstraPth
    ...
    def run(self):
        ...
        while True:
            ...
            if userInput == 1:
                ...
                startingVertex = int(input("Please insert the number of the starting vertex: "))
                endingVertex = int(input("Please insert the number of the ending vertex: "))
                print(DijkstraPth(self.__graph, startingVertex, endingVertex))
